            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-800 bg-slate-900/90 pl-10 pr-4 py-2.5 text-sm text-white placeholder-slate-500 focus:border-[#038AF9] focus:outline-none focus:ring-1 focus:ring-[#038AF9] transition-colors"
                />
              </div>
              {errors.email && (
