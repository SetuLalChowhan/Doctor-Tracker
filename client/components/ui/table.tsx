...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 px-4 text-left align-middle text-[11px] font-extrabold uppercase tracking-wider text-slate-800 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-4 align-middle text-sm font-semibold text-slate-900 [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
));
